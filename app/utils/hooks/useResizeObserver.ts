...
export default function useResizeObserver<T extends HTMLElement>(options?: { ref: RefObject<T | undefined> | HTMLElement }): [ Dimensions, BoundingRect ] {
    ...
    useEffect(() => {
        ...
        const resizeObserver = new ResizeObserver((entries) => {
            ...
            if (element) {
                ...
                const left = _boundingRect.left, right = _boundingRect.right, top = _boundingRect.top, bottom = _boundingRect.bottom;
